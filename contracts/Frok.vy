...
# @notice Just a basic ERC721, nothing fancy.
# @dev This would be equivalent to Llama.vy (https://github.com/wen-llama/thellamas/blob/main/contracts/Llama.vy) except for removing the allowlist, bulk minting functionality, and supply limit.
# @author johnnyonline
# @license MIT
...
MAX_LENGTH: constant(uint256) = 1000000000
...
# NFT Data
ids_by_owner: HashMap[address, DynArray[uint256, MAX_LENGTH]]
...
@external
@view
def tokensForOwner(owner: address) -> DynArray[uint256, MAX_LENGTH]:
